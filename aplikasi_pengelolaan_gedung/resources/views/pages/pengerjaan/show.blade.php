                ...
                <div class="card-body">
                    <form
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$data->tanggal_batas_pengerjaan}}" class="form-control" type="date" id="tanggal_batas_pengerjaan" name="tanggal_batas_pengerjaan" readonly>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content tabcontent-border p-20" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab">
                                        <p>&nbsp;</p>
                                        <div id="myDropzonePerbaikanPengerjaan" class="dropzone"></div>
                                        <p>&nbsp;</p>
