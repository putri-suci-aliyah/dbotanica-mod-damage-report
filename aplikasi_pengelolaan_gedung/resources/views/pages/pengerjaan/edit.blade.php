            ...
            <div class="card">
                <div class="card-body">
                    <form
                        ...
                        class="m-t-30"
                        action='{{ url('pengerjaan_perbaikan/'.$data->id) }}'
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$data->tanggal_temuan_kerusakan}}" class="form-control" type="date" id="tanggal_temuan_kerusakan" name="tanggal_temuan_kerusakan" readonly>
                        </div>
                        <div class="form-group">
                            <label>Tanggal Batas Pengerjaan</label>
                            <input value="{{$data->tanggal_batas_pengerjaan}}" class="form-control" type="date" id="tanggal_batas_pengerjaan" name="tanggal_batas_pengerjaan" required>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="tab-content tabcontent-border p-20" id="myTabContent">
                                    ...
                                    {{-- <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab">
                                        <p>&nbsp;</p>
                                        <div id="image-pengerjaan-dropzone" class="dropzone"></div>
                                        <p>&nbsp;</p>
                                        <textarea  id="editor2" name="keterangan_perbaikan"></textarea>
                                    </div> --}}
                                    ...
                                    <div class="tab-pane fade" id="profile5" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div id="image-pengerjaan-dropzone" class="dropzone"></div>
                                        <p>&nbsp;</p>
                                        <textarea  id="editor2" name="keterangan_perbaikan">{{$data->keterangan_perbaikan}}</textarea>
                                    </div>
                        ...
                        <div class="form-group">
                            <a href="{{ url('pengerjaan_perbaikan') }}" class="btn btn-dark mr-2">Batal</a>
